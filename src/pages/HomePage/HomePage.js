          ...
          <div className="card__section--layout">
            <div className="about__card">
              ...
              <p className="about__text">
                ...
                organization, business, or group, qualitative feedback and
                opinion can be difficult to make sense of or summarise
                consisely. The belief behind MELDER is that language modelling
                may serve as a useful tool for this purpose. As this is a
                prototypal product, we are still testing the various outputs and
                how to adjust those to different requirements. Try for yourself!
              </p>
            </div>
